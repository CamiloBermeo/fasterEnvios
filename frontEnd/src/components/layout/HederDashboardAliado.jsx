...
const HederDashboardAliado = () => {
    ...
    return (
        <div className="flex justify-between items-center gap-8 bg-white h-full w-full px-6 ">
            <div className="flex ">
                <h1 className="text-2xl font-bold">Dashboard</h1>
            </div>


            <div className="flex flex-1 mx-10 max-w-md bg-white rounded-3xl px-4 py-1 border border-gray-200">
                <button><img src={BuscarDashboard} alt="buscar" className="w-5 h-5" /></button>
                <input
            ...
            <div className="flex gap-4 items-center">
                ...
                <button className="overflow-hidden rounded-full border-2 border-white shadow-sm">
